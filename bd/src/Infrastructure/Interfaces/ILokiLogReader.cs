...
public interface ILokiLogReader
{
    ...
    Task<IReadOnlyCollection<AgentLogDto>> GetByAgentForExportAsync(string agentId, DateTimeOffset fromUtc, DateTimeOffset toUtc, int limit = 100000, CancellationToken ct = default);
