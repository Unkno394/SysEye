...
public interface ICommandService
{
    ...
    Task<Command> CreateAsync(Guid userId, string name, string description, string bashScript, string powerShellScript, CancellationToken ct);
    ...
    Task<bool> UpdateAsync(Guid commandId, Guid userId, string? name, string? description, string? bashScript, string? powerShellScript, string? logRegex, CancellationToken ct);
